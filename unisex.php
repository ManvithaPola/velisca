...
$sql = "SELECT p.*, c.category_name FROM products p 
        ...
        WHERE p.category_id = 3"; // Men category
...
<head>
    ...
    <title>Unisex Essentials | Velisca</title>
    <!-- Tailwind CSS -->
...
<body class="bg-white text-black relative">
    ...
    <main class="pt-24">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="text-gray-400">Unisex Essentials</span>
                        </div>
                    </li>
                </ol>
            </nav>
        ...
        <section class="py-16 bg-gray-50">
            <div class="container mx-auto px-4 text-center">
                <h1 class="text-4xl md:text-5xl font-light mb-4" data-aos="fade-up">Unisex Essentials</h1>
                <p class="text-gray-600" data-aos="fade-up">Timeless, versatile pieces that define effortless style for everyone</p>
            </div>
        </section>
  ...
  <option value="Designer Streetwear" <?= ($selectedSubcategory == 'Designer Streetwear') ? 'selected' : '' ?>>Designer Streetwear</option>
  <option value="Luxury Fragnances" <?= ($selectedSubcategory == 'Luxury Fragnances') ? 'selected' : '' ?>>Luxury Fragnances</option>
  <option value="Branded Tote Bags" <?= ($selectedSubcategory == 'Branded Tote Bags') ? 'selected' : '' ?>>Branded Tote Bags</option>
  <option value="Velisca Logo Accessories" <?= ($selectedSubcategory == 'Velisca Logo Accessories') ? 'selected' : '' ?>>Velisca Logo Accessories</option>
  <option value="Trendy Sneakers" <?= ($selectedSubcategory == 'Trendy Sneakers') ? 'selected' : '' ?>>Trendy Sneakers</option>
</select>
