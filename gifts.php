...
$sql = "SELECT p.*, c.category_name FROM products p 
        ...
        WHERE p.category_id = 5"; // Men category
...
<head>
    ...
    <title>Special Collections & Gift Sets | Velisca</title>
    <!-- Tailwind CSS -->
...
<body class="bg-white text-black relative">
    ...
    <main class="pt-24">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="text-gray-400">Special Collections & Gift Sets</span>
                        </div>
                    </li>
                </ol>
            </nav>
        ...
        <section class="py-16 bg-gray-50">
            <div class="container mx-auto px-4 text-center">
                <h1 class="text-4xl md:text-5xl font-light mb-4" data-aos="fade-up">Special Collections & Gift Sets</h1>
                <p class="text-gray-600" data-aos="fade-up">Exquisite collections and thoughtful gifts, crafted for unforgettable moments</p>
            </div>
        </section>
  ...
  <option value="His & Hers Gift Boxes" <?= ($selectedSubcategory == 'His & Hers Gift Boxes') ? 'selected' : '' ?>>His & Hers Gift Boxes</option>
  <option value="Red Carpet-Inspired Styles" <?= ($selectedSubcategory == 'Red Carpet-Inspired Styles') ? 'selected' : '' ?>>Red Carpet-Inspired Styles</option>
  <option value="Wedding Edit" <?= ($selectedSubcategory == 'Wedding Edit') ? 'selected' : '' ?>>Wedding Edit</option>
  <option value="Holiday Luxury Hampers" <?= ($selectedSubcategory == 'Holiday Luxury Hampers') ? 'selected' : '' ?>>Holiday Luxury Hampers</option>
  <option value="Velisca VIP Curated Box (Monthly)" <?= ($selectedSubcategory == 'Velisca VIP Curated Box (Monthly)') ? 'selected' : '' ?>>Velisca VIP Curated Box (Monthly)</option>
</select>
