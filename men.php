...
$sql = "SELECT p.*, c.category_name FROM products p 
        ...
        WHERE p.category_id = 2"; // Men category
...
<head>
    ...
    <title>Men's Collection | Velisca</title>
    <!-- Tailwind CSS -->
...
<body class="bg-white text-black relative">
    ...
    <nav class="bg-black text-white py-6 fixed w-full z-50 transition-all duration-300" id="main-nav">
        <div class="container mx-auto px-4 flex justify-between items-center">
            ...
            <div class="hidden lg:flex space-x-8 text-sm tracking-wider">
                ...
                <a href="cart.php" class="nav-link hover:text-beige" style="color: #EFE1CB;">GIFTS</a>
            </div>
    ...
    <main class="pt-24">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="text-gray-400">Men's Collection</span>
                        </div>
                    </li>
                </ol>
            </nav>
        ...
        <section class="py-16 bg-gray-50">
            <div class="container mx-auto px-4 text-center">
                <h1 class="text-4xl md:text-5xl font-light mb-4" data-aos="fade-up">Men's Collection</h1>
                <p class="text-gray-600" data-aos="fade-up">Discover our latest designs for the modern men</p>
            </div>
        </section>
  ...
  <option value="Custom-Fit Suits" <?= ($selectedSubcategory == 'Custom-Fit Suits') ? 'selected' : '' ?>>Custom-Fit Suits</option>
  <option value="Designer Shirts (Silk/Linen)" <?= ($selectedSubcategory == 'Designer Shirts (Silk/Linen)') ? 'selected' : '' ?>>Designer Shirts (Silk/Linen)</option>
  <option value="Italian Leather Jackets" <?= ($selectedSubcategory == 'Italian Leather Jackets') ? 'selected' : '' ?>>Italian Leather Jackets</option>
  <option value="Premium Watches" <?= ($selectedSubcategory == 'Premium Watches') ? 'selected' : '' ?>>Premium Watches</option>
  <option value="Fragrance for Him" <?= ($selectedSubcategory == 'Fragrance for Him') ? 'selected' : '' ?>>Fragrance for Him</option>
</select>
