...
$sql = "SELECT p.*, c.category_name FROM products p 
        ...
        WHERE p.category_id = 4"; // Men category
...
<head>
    ...
    <title>Lifestyle & Home Collection | Velisca</title>
    <!-- Tailwind CSS -->
...
<body class="bg-white text-black relative">
    ...
    <main class="pt-24">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="text-gray-400">Lifestyle & Home Collection</span>
                        </div>
                    </li>
                </ol>
            </nav>
        ...
        <section class="py-16 bg-gray-50">
            <div class="container mx-auto px-4 text-center">
                <h1 class="text-4xl md:text-5xl font-light mb-4" data-aos="fade-up">Lifestyle & Home Collection</h1>
                <p class="text-gray-600" data-aos="fade-up">Elevate your living space with timeless luxury and curated elegance</p>
            </div>
        </section>
  ...
  <option value="Designer Throw Blankets" <?= ($selectedSubcategory == 'Designer Throw Blankets') ? 'selected' : '' ?>>Designer Throw Blankets</option>
  <option value="Handcrafted Vases" <?= ($selectedSubcategory == 'Handcrafted Vases') ? 'selected' : '' ?>>Handcrafted Vases</option>
  <option value="Premium cushion sets" <?= ($selectedSubcategory == 'Premium cushion sets') ? 'selected' : '' ?>>Premium cushion sets</option>
  <option value="Scented Soy Candles" <?= ($selectedSubcategory == 'Scented Soy Candles') ? 'selected' : '' ?>>Scented Soy Candles</option>
  <option value="Luxury Wall Art Prints" <?= ($selectedSubcategory == 'Luxury Wall Art Prints') ? 'selected' : '' ?>>Luxury Wall Art Prints</option>
</select>
